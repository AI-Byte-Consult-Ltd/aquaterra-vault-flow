import{c as u,n as w,b as O,r as d,i as N,x as n,o as Q,U as be,a as ye}from"./index-mJdcRJKg.js";import{p as xe,w as Ce,s as ke,q as Se,R as l,M as v,t as de,i as _,r as B,a as D,x as f,u as X,e as we,o as ue,j as m,f as F,k as We,v as k,c as ne,O as I,C as Z,y as se,l as A,A as V,T as $e,z as Re,b as Ae,h as Te}from"./core-BN5qo77i.js";import"./index-BjplTv7Y.js";import"./index.es-D9li2tNj.js";const p=xe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Oe={state:p,subscribe(s){return ke(p,()=>s(p))},subscribeKey(s,e){return Se(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},T=Ce(Oe),pe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){v.shake();return}if(await de.isSIWXCloseDisabled()){v.shake();return}v.close()}},Ne=_`
  :host {
    display: block;
